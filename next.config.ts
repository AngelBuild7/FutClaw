...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    // Pretty embed URL: futclaw.com/<username>.png -> the card image route. The
    ...
    return [
      { source: "/youtube/:username([a-zA-Z0-9_-]+).png", destination: "/api/card-image/:username?platform=youtube" },
