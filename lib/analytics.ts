...
const TOTAL_KEY = "futclaw:scouts:total";

// Increment the all-time scout counter. Best-effort: never throws and never
...
// Current scout count for the home counter. Null when unavailable (Redis off, or
