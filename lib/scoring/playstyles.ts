...
// A predefined catalog of platform "playstyles". Each fires when its real signal
...
const YOUTUBE_CATALOG: PlaystyleDef[] = [
  { name: "Audience Magnet", icon: "users", noun: "subscribers", value: (s) => s.subscribers ?? 0, base: 10_000, plus: 1_000_000 },
  { name: "Viral Hit", icon: "flame", noun: "average recent views", value: (s) => s.avg_views_recent ?? 0, base: 25_000, plus: 1_000_000 },
  { name: "Workhorse", icon: "zap", noun: "uploads this year", value: (s) => s.recent_uploads ?? 0, base: 24, plus: 100 },
  { name: "Marathoner", icon: "infinity", noun: "total views", value: (s) => s.total_views ?? 0, base: 1_000_000, plus: 100_000_000 },
  { name: "Connector", icon: "git-pull-request", noun: "average comments", value: (s) => s.avg_comments_recent ?? 0, base: 100, plus: 10_000 },
  { name: "Crowd Favorite", icon: "star", noun: "average likes", value: (s) => s.avg_likes_recent ?? 0, base: 500, plus: 50_000 },
  { name: "Variety Creator", icon: "languages", noun: "content categories", value: (s) => s.category_count ?? 0, base: 3, plus: 8 },
  { name: "Prolific", icon: "folder-git", noun: "videos published", value: (s) => s.video_count ?? 0, base: 50, plus: 1_000 },
  { name: "Veteran", icon: "clock", noun: "years on YouTube", value: (s) => s.channel_age_years ?? s.account_age_years, base: 5, plus: 12 },
];
...
export function derivePlaystyles(s: Signals): Playstyle[] {
  const catalog = s.subscribers !== undefined && s.video_count !== undefined ? YOUTUBE_CATALOG : CATALOG;
