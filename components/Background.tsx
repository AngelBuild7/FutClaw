    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden bg-bg">
      ...
      <div
        ...
        style={{
          ...
          height: "92%",
          background:
            "radial-gradient(50% 62% at 50% 0%, rgba(229,62,62,.12), rgba(0,0,0,.15) 46%, rgba(0,0,0,0) 72%)",
        }}
      />
      {/* left cool wash */}
      <div
        ...
        style={{
          ...
          width: "38%",
          height: "78%",
          background: "radial-gradient(closest-side, rgba(229,62,62,.08), transparent 72%)",
          filter: "blur(18px)",
          transform: "rotate(16deg)",
        }}
      />
      {/* right whisper of gold — prestige, kept subtle */}
      <div
        className="absolute"
        style={{
          top: "-10%",
          ...
          width: "34%",
          height: "78%",
          background: "radial-gradient(closest-side, rgba(245,166,35,.06), transparent 72%)",
          filter: "blur(20px)",
          transform: "rotate(-16deg)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(60% 100% at 50% 100%, rgba(0,0,0,.9), transparent 72%)",
        }}
      />
